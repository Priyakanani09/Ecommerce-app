...
function Electronics() {
    ...
    const fetchProducts = (pageNumber) => {
       fetch(`https://ecommerce-app-1-igf3.onrender.com/products?page=${pageNumber}&category=electronics`)
          .then((res) => res.json())
          .then((data) => {
            const filteredProducts = data.products.filter(product => product.category && product.category.toLowerCase().includes('electronics'));
